...
function Card({value}){
    ...
    return(
        <div className=" w-72  flex flex-col rounded-xl glass  min-h-72 mt-3 hover:scale-[1.1] hover:shadow-xl transition-all">
        <div>
          <img
        ...
        <div className="flex flex-col py-3 px-3 pb-7 -mt-4 bg-black rounded-b-xl ">
          <div className="flex justify-between">
            <h1 className="font-RubikBold ">Intractive UI</h1>
